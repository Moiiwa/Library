...
import TableWithoutButtons from '../TableWithoutButtons/TableWithoutButtons';
...
describe('List', () => {
    ...
    it('renders correctly with props', () => {
        const props = {
            books: [{ id: 1, title: "title", author: "author", owner: "owner" }]
        }
        const wrapper = shallow(<TableWithoutButtons {...props} />);
